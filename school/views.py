...
@login_required(login_url='studentlogin')
@user_passes_test(is_student)
def student_teacher_view(request):
    return render(request,'school/student_teacher.html')

@login_required(login_url='studentlogin')
@user_passes_test(is_student)
def student_view_teacher_view(request):
    teachers=models.TeacherExtra.objects.all().filter(status=True)
    return render(request,'school/student_view_teacher.html',{'teachers':teachers})
